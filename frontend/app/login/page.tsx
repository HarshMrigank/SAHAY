...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      // For now redirecting to victim dashboard
          ...
          <form className="space-y-6" onSubmit={handleLogin}>
            <div>
              ...
              <input
                ...
                className="mt-1 appearance-none block w-full px-3 py-2 border border-input rounded-md shadow-sm placeholder-muted-foreground focus:outline-none focus:ring-primary focus:border-primary sm:text-sm bg-background text-foreground"
                required
              />
            </div>
